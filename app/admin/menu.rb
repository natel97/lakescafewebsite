              ...
              unless _heading_attr.sections.empty?
                table_for _heading_attr.sections do |_section|
                  fields_for 'sections[]', _section do |_sect_f|
                    ...
                    _section.column('Description') { |_a| _form.text_field :description, value: _a.description, id: 'section_descriptions[' + _a.id.to_s + ']', name: 'section_descriptions[' + _a.id.to_s + ']' }
                      ...
                      unless _section_attr.items.empty?
                        table_for _section_attr.items do |t|
                          fields_for 'items[]', t do |_item_f|
                            ...
                            t.column('Description') { |_a| _form.text_field :description, value: _a.description, id: 'item_description[' + _a.id.to_s + ']', name: 'item_description[' + _a.id.to_s + ']' }
                              ...
                              unless _item_attr.sub_items.empty?
                                table_for _item_attr.sub_items do |_st|
                                  fields_for 'sub_items', _st do |_si_f|
                                    ...
                                    _st.column('Description') { |_a| _form.text_field :description, value: _a.description, id: 'sub_item_description[' + _a.id.to_s + ']', name: 'sub_item_description[' + _a.id.to_s + ']' }
